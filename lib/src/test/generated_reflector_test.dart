...
void main() {
  group('Reflection test', () {
    ...
    test('Generate file reflect', () async {
      await ReflectorGenerator(directories: ['${DirectoryUtilities.prefixRouteLocal}/lib'], fileCreationPlace: '${DirectoryUtilities.prefixRouteLocal}/lib/src/reflection', albumName: 'MaxiLibraryDbMysql').build();
    });
